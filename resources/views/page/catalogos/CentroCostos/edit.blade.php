        ...
        <div class="contentpanel">
            <div class="row row-stat">
                <div class="contenedor-formulario">
                    {!! Form::open([
                        'route' => ['catalogo.centroCostos.update', Crypt::encrypt($centro_edit['costCenter_id'])],
                        'method' => 'PUT',
                         'id' => 'basicForm']) !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group mt10">
                            ...
                            {!! Form::text('keyCentroCosto', $centro_edit['costCenter_key'], ['class' => 'form-control', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group mt10">
                            ...
                            {!! Form::text('nameCentroCosto', $centro_edit['costCenter_name'], ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group mt10">
                            ...
                            {!! Form::select('status', ['Alta' => 'Alta', 'Baja' => 'Baja'], $centro_edit['costCenter_status'], [
                    ...
                    <div class="col-md-12 mt20 display-center">
                        ...
                        {!! Form::submit('Guardar Centro de Costo', ['class' => 'btn btn-warning enviar']) !!}
                    </div>
