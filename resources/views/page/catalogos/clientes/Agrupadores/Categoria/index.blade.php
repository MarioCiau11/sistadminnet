                            ...
                            <tr>
                                <td class="td-option">
                                    <div class="contenedor-opciones">
                                        ...
                                        <a href="{{ route('editCategoria', [Crypt::encrypt($categoria->categoryCostumer_id), 'tipo' => 'Cliente']) }}"
                                            class="edit" data-toggle="tooltip" data-placement="top"
                                            title="Editar registro"><i class="fa fa-pencil-square-o"
                                                aria-hidden="true"></i></a>
                                        @if ($categoria->categoryCostumer_status == 'Alta')
                                            {!! Form::open([
                                                'route' => ['deleteCategory', 'categoria' => Crypt::encrypt($categoria->categoryCostumer_id), 'tipo' => 'Cliente'],
                                                'method' => 'DELETE',
                                                'id' => 'deleteForm',
                                            ]) !!}
                                ...
                                <td>{{ $categoria->categoryCostumer_id }}</td>
                                <td>{{ $categoria->categoryCostumer_name }}</td>
                                <td>{{ $categoria->categoryCostumer_status }}</td>
