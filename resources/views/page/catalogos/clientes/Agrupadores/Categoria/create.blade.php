    ...
    <div class="contentpanel">
        <div class="row row-stat">
            <div class="contenedor-formulario">
                {!! Form::open(['route' => ['agregarCategoria', 'tipo' => 'Cliente'],'id' => 'basicForm']) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('keyClave',null,['class'=>'form-control',  'disabled', 'id'=>'keyCliente']) !!}
                    </div>
                </div>
...
<script>
    ...
    jQuery(document).ready(function (){
        ...
        $.get('/categoria/getCategoria', {tipo: 'Cliente'}, function(resp) {
