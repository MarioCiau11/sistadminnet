                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Categorías de Articulos</li>
                        </ul>
                        <h4>Categorías de Articulos</h4>
                    </div>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
                            ...
                            <tr>
                                <td class="td-option">
                                    <div class="contenedor-opciones">
                                        ...
                                        <a href="{{ route('editCategoria', [Crypt::encrypt($categoria->categoryArticle_id), 'tipo' => 'Articulo']) }}"
                                            class="edit" data-toggle="tooltip" data-placement="top"
                                            title="Editar registro"><i class="fa fa-pencil-square-o"
                                                aria-hidden="true"></i></a>

                                        @if ($categoria->categoryArticle_status == 'Alta')
                                            {!! Form::open([
                                                'route' => ['deleteCategory', 'categoria' => Crypt::encrypt($categoria->categoryArticle_id), 'tipo' => 'Articulo'],
                                                'method' => 'DELETE',
                                                'id' => 'deleteForm',
                                            ]) !!}
                                ...
                                <td>{{ $categoria->categoryArticle_id }}</td>
                                <td>{{ $categoria->categoryArticle_name }}</td>
                                <td>{{ $categoria->categoryArticle_status }}</td>
