    ...
    <div class="contentpanel">
        <div class="row row-stat">
            <div class="contenedor-formulario">
                {!! Form::open(['route' => ['updateFamilia', Crypt::encrypt($familia_edit->familyArticle_id), 'tipo' => 'Articulo'], 'id' => 'basicForm',  'method'=>'PUT']) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('keyClave',$familia_edit->familyArticle_id,['class'=>'form-control', 'disabled']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('nameNombre',$familia_edit->familyArticle_name,['class'=>'form-control', 'id'=>'nameNombre']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group mt10">
                        ...
                        {!! Form::select('statusDG', ['Alta' => 'Alta', 'Baja' => 'Baja'], $familia_edit->familyArticle_status, array('id' => 'select-search-hide-dg', "class" => 'widthAll select-status')) !!} 
                    </div>
                </div>
