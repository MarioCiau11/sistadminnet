                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Familia de Articulos</li>
                        </ul>
                        <h4>Familia de Articulos</h4>
                    </div>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
                            ...
                            <tr>
                                <td class="td-option">
                                    <div class="contenedor-opciones">
                                        ...
                                        <a href="{{ route('editFamilia', [Crypt::encrypt($familia->familyArticle_id), 'tipo' => 'Articulo']) }}"
                                            class="edit" data-toggle="tooltip" data-placement="top"
                                            title="Editar registro"><i class="fa fa-pencil-square-o"
                                                aria-hidden="true"></i></a>

                                        @if ($familia->familyArticle_status == 'Alta')
                                            {!! Form::open([
                                                'route' => ['deleteFamilia', 'categoria' => Crypt::encrypt($familia->familyArticle_id), 'tipo' => 'Articulo'],
                                                'method' => 'DELETE',
                                                'id' => 'deleteForm',
                                            ]) !!}
                                ...
                                <td>{{ $familia->familyArticle_id }}</td>
                                <td>{{ $familia->familyArticle_name }}</td>
                                <td>{{ $familia->familyArticle_status }}</td>
