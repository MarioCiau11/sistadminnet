    ...
    <div class="contentpanel">
        <div class="row row-stat">
            <div class="contenedor-formulario">
                {!! Form::open(['route' => ['agregarFamilia', 'tipo' => 'Articulo'], 'id' => 'basicForm']) !!}
                ...
                <div class="col-md-12 mt20 display-center">
                    {!! Form::submit("Crear Familia", ['class' => 'btn btn-success enviar']) !!}
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
<script>
    ...
    jQuery(document).ready(function (){
        ...
        $.get('/getFamilia', {tipo: 'Articulo'}, function(resp) {
