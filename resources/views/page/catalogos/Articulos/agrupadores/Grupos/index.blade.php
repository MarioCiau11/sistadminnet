                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Grupos de Artículos</li>
                        </ul>
                        <h4>Grupos de Artículos</h4>
                    </div>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
                            ...
                            <tr>
                                <td class="td-option">
                                    <div class="contenedor-opciones">
                                        ...
                                        <a href="{{ route('editGrupo', [Crypt::encrypt($grupo->groupArticle_id), 'tipo' => 'Articulo']) }}"
                                            class="edit" data-toggle="tooltip" data-placement="top"
                                            title="Editar registro"><i class="fa fa-pencil-square-o"
                                                aria-hidden="true"></i></a>

                                        {!! Form::open([
                                            'route' => ['deleteGrupo', 'grupo' => Crypt::encrypt($grupo->groupArticle_id), 'tipo' => 'Articulo'],
                                            'method' => 'DELETE',
                                            'id' => 'deleteForm',
                                        ]) !!}
                                ...
                                <td>{{ $grupo->groupArticle_id }}</td>
                                <td>{{ $grupo->groupArticle_name }}</td>
                                <td>{{ $grupo->groupArticle_status }}</td>
