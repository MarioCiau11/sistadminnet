    ...
    <div class="contentpanel">
        <div class="row row-stat">
            <div class="contenedor-formulario">
                {!! Form::open(['route' => ['updateGrupo', Crypt::encrypt($grupo_edit->groupArticle_id) , 'tipo' => 'Articulo'],'id' => 'basicForm','method'=>'PUT']) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('keyClave',$grupo_edit->groupArticle_id,['class'=>'form-control', 'disabled']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('nameNombre',$grupo_edit->groupArticle_name,['class'=>'form-control']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group mt10">
                        ...
                        {!! Form::select('statusDG', ['Alta' => 'Alta', 'Baja' => 'Baja'],$grupo_edit->groupArticle_status , array('id' => 'select-search-hide-dg', "class" => 'widthAll select-status')) !!} 
                    </div>
                </div>
