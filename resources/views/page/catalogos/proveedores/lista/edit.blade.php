        ...
        <div class="contentpanel">
            <div class="row row-stat">
                <div class="contenedor-formulario">
                    {!! Form::open([
                        'route' => ['listaUpdate', Crypt::encrypt($provider['listProvider_id'])],
                        'method' => 'PUT',
                        'id' => 'basicForm',
                    ]) !!}
                        ...
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mt10">
                                    ...
                                    {!! Form::text('nameList', $provider['listProvider_name'], ['class' => 'form-control', 'id' => 'nameList']) !!}
                                </div>
                            </div>
                                    ...
                                    <table id="shTable1" class="table table-striped table-bordered widthAll">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger btn-sm btn-remove-article">
                    ...
                    <div class="col-md-12 mt20 display-flex text-center">
                        ...
                        {!! Form::submit('Guardar Lista', ['class' => 'btn btn-warning enviar']) !!}
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            jQuery("#agregarArticulo").click(async function(){
                let rowData = tablaArticulos.rows({ selected: true }).data();
            ...
            // Agrega un manejador de eventos para el botón de eliminación en la tabla de edición
            ...
            jQuery("#basicForm").validate({
                ...
                window.location.href = "{{ route('listaIndex') }}";
            });
