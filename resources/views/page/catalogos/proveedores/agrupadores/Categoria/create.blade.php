    ...
    <div class="contentpanel">
        <div class="row row-stat">
            <div class="contenedor-formulario">
                {!! Form::open(['route' => ['agregarCategoria', 'tipo' => 'Proveedor'],'id' => 'basicForm']) !!}
                ...
                <div class="col-md-12 mt20 display-center">
                    {!! Form::submit("Crear Categoria", ['class' => 'btn btn-success enviar']) !!}
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
<script>
    ...
    jQuery(document).ready(function (){
        ...
        $.get('/categoria/getCategoria', {tipo: 'Proveedor'}, function(resp) {
