    ...
    <div class="contentpanel">
        <div class="row row-stat">
            <div class="contenedor-formulario">
                {!! Form::open(['route' => ['updateCategoria', Crypt::encrypt($categoria_edit->categoryProvider_id), 'tipo' => 'Proveedor'], 'id' => 'basicForm',  'method'=>'PUT']) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('keyClave',$categoria_edit->categoryProvider_id,['class'=>'form-control', 'disabled']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('nameNombre',$categoria_edit->categoryProvider_name,['class'=>'form-control', 'id'=>'nameNombre']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group mt10">
                        ...
                        {!! Form::select('statusDG', ['Alta' => 'Alta', 'Baja' => 'Baja'], $categoria_edit->categoryProvider_status, array('id' => 'select-search-hide-dg', "class" => 'widthAll select-status')) !!} 
                    </div>
                </div>
