                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Grupos de Proveedores</li>
                        </ul>
                        <h4>Grupos de Proveedores</h4>
                    </div>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
                            ...
                            <tr>
                                <td class="td-option">
                                    <div class="contenedor-opciones">
                                        ...
                                        <a href="{{ route('editGrupo', [Crypt::encrypt($grupo->groupProvider_id), 'tipo' => 'Proveedor']) }}"
                                            class="edit" data-toggle="tooltip" data-placement="top"
                                            title="Editar registro"><i class="fa fa-pencil-square-o"
                                                aria-hidden="true"></i></a>

                                        {!! Form::open([
                                            'route' => ['deleteGrupo', 'grupo' => Crypt::encrypt($grupo->groupProvider_id), 'tipo' => 'Proveedor'],
                                            'method' => 'DELETE',
                                            'id' => 'deleteForm',
                                        ]) !!}
                                ...
                                <td>{{ $grupo->groupProvider_id }}</td>
                                <td>{{ $grupo->groupProvider_name }}</td>
                                <td>{{ $grupo->groupProvider_status }}</td>
