                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Categorías de Conceptos de gastos</li>
                        </ul>
                        <h4>Categorías de Conceptos de gastos</h4>
                    </div>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
                            ...
                            <tr>
                                <td class="td-option">
                                    <div class="contenedor-opciones">
                                        ...
                                        <a href="{{ route('editCategoria', [Crypt::encrypt($categoria->categoryExpenseConcept_id), 'tipo' => 'cptGastos']) }}"
                                        ...
                                        {!! Form::open([
                                            'route' => [
                                                'deleteCategory',
                                                'categoria' => Crypt::encrypt($categoria->categoryExpenseConcept_id),
                                                'tipo' => 'cptGastos',
                                            ],
                                            'method' => 'DELETE',
                                            'id' => 'deleteForm',
                                ...
                                <td>{{ $categoria->categoryExpenseConcept_id }}</td>
                                <td>{{ $categoria->categoryExpenseConcept_name }}</td>
                                <td>{{ $categoria->categoryExpenseConcept_status }}</td>
