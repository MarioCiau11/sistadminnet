    ...
    <div class="contentpanel">
        <div class="row row-stat">
            <div class="contenedor-formulario">
                {!! Form::open(['route' => ['agregarCategoria', 'tipo' => 'cptGastos'],'id' => 'basicForm']) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group mt10" >
                        {!! Form::labelValidacion('keyCategoria', 'Clave', 'negrita') !!}
                        {!! Form::text('keyCategoria',null,['class'=>'form-control', 'disabled', 'id'=> 'keyCategoria']) !!}
                    </div>
                </div>
...
<script>
    ...
    jQuery(document).ready(function (){
        ...
        $.get('/categoria/getCategoria', {tipo: 'cptGastos'}, function(resp) {
