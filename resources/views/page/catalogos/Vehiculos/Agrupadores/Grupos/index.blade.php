                            ...
                            <tr>
                                <td class="td-option">
                                    <div class="contenedor-opciones">
                                        ...
                                        <a href="{{ route('editGrupo', [Crypt::encrypt($grupo->groupVehicle_id), 'tipo' => 'Vehiculo']) }}"
                                            class="edit" data-toggle="tooltip" data-placement="top"
                                            title="Editar registro"><i class="fa fa-pencil-square-o"
                                                aria-hidden="true"></i></a>

                                        {!! Form::open([
                                            'route' => ['deleteGrupo', 'grupo' => Crypt::encrypt($grupo->groupVehicle_id), 'tipo' => 'Vehiculo'],
                                            'method' => 'DELETE',
                                            'id' => 'deleteForm',
                                        ]) !!}
                                ...
                                <td>{{ $grupo->groupVehicle_id }}</td>
                                <td>{{ $grupo->groupVehicle_name }}</td>
                                <td>{{ $grupo->groupVehicle_status }}</td>
