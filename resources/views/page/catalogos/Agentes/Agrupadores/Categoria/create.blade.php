    ...
    <div class="contentpanel">
        <div class="row row-stat">
            <div class="contenedor-formulario">
                {!! Form::open(['route' => ['agregarCategoria', 'tipo' => 'Agente'],'id' => 'basicForm']) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('keyClave',null,['class'=>'form-control', 'disabled', 'id'=>'keyCategoria']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('nameNombre',null,['class'=>'form-control', 'id'=>'nameNombre']) !!}
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group mt10">
                ...
                <div class="col-md-12 mt20 display-center">
                    {!! Form::submit("Crear Categoría", ['class' => 'btn btn-success enviar']) !!}
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
<script>
    jQuery(document).ready(function (){
        ...
        $.get('/categoria/getCategoria', {tipo: 'Agente'}, function(resp) {
                $.each(resp, function(i, item) {
                    $('#keyCategoria').val(item)
                });
            });
