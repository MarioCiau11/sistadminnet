    ...
    <div class="contentpanel">
        <div class="row row-stat">
            <div class="contenedor-formulario">
                {!! Form::open(['route' => ['updateCategoria', Crypt::encrypt($categoria_edit->categoryAgents_id), 'tipo' => 'Agente'], 'id' => 'basicForm',  'method'=>'PUT']) !!}
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h2 class="text-black">Datos Generales de la Categoría</h2>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('keyClave',$categoria_edit->categoryAgents_id,['class'=>'form-control', 'disabled']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('nameNombre',$categoria_edit->categoryAgents_name,['class'=>'form-control', 'id'=>'nameNombre']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group mt10">
                        ...
                        {!! Form::select('statusDG', ['Alta' => 'Alta', 'Baja' => 'Baja'], $categoria_edit->categoryAgents_status, array('id' => 'select-search-hide-dg', "class" => 'widthAll select-status')) !!} 
                    </div>
                </div>
