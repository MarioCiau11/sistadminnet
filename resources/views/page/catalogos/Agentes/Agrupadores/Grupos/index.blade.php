                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Grupos de Operativos</li>
                        </ul>
                        <h4>Grupos de Operativos</h4>
                    </div>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
                            ...
                            <tr>
                                <td class="td-option">
                                    <div class="contenedor-opciones">
                                        ...
                                        <a href="{{ route('editGrupo', [Crypt::encrypt($grupo->groupAgents_id), 'tipo' => 'Agente']) }}"
                                            class="edit" data-toggle="tooltip" data-placement="top"
                                            title="Editar registro"><i class="fa fa-pencil-square-o"
                                                aria-hidden="true"></i></a>

                                        {!! Form::open([
                                            'route' => ['deleteGrupo', 'grupo' => Crypt::encrypt($grupo->groupAgents_id), 'tipo' => 'Agente'],
                                            'method' => 'DELETE',
                                            'id' => 'deleteForm',
                                        ]) !!}
                                ...
                                <td>{{ $grupo->groupAgents_id }}</td>
                                <td>{{ $grupo->groupAgents_name }}</td>
                                <td>{{ $grupo->groupAgents_status }}</td>
