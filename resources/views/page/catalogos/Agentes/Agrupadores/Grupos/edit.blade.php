    ...
    <div class="contentpanel">
        <div class="row row-stat">
            <div class="contenedor-formulario">
                {!! Form::open(['route' => ['updateGrupo', Crypt::encrypt($grupo_edit->groupAgents_id) , 'tipo' => 'Agente'],'id' => 'basicForm','method'=>'PUT']) !!}
                ...
                {!! Form::macro('labelValidacion', function ($name, $labelName, $classes){
                  ...
                  <div class="col-md-12">
                    <div class="col-md-6">
                        <h2 class="text-black">Datos Generales del Grupo</h2>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('keyClave',$grupo_edit->groupAgents_id,['class'=>'form-control', 'disabled']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mt10" >
                        ...
                        {!! Form::text('nameNombre',$grupo_edit->groupAgents_name,['class'=>'form-control', 'id'=>'nameNombre']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group mt10">
                        ...
                        {!! Form::select('statusDG', ['Alta' => 'Alta', 'Baja' => 'Baja'], $grupo_edit->groupAgents_status, array('id' => 'select-search-hide-dg', "class" => 'widthAll select-status')) !!} 
                    </div>
                </div>
                ...
                <div class="col-md-12 mt20 display-center">
                    {!! Form::submit("Guardar Grupo", ['class' => 'btn btn-warning enviar']) !!}
                </div>
                {!! Form::close() !!}
            </div>
        </div>
