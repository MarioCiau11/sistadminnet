        ...
        <div class="contentpanel">
            <div class="row row-stat">
                <div class="contenedor-formulario">
                    {!! Form::open([
                        'route' => ['configuracion.concepto-modulos.update', $concepto_edit['moduleConcept_id']],
                        'method' => 'PUT',
                        'id' => 'basicForm',
                    ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="form-group mt10">
                            ...
                            {!! Form::text('nameConcepto', $concepto_edit['moduleConcept_name'], ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group mt10">
                            ...
                            {!! Form::select(
                                ...
                                $concepto_edit['moduleConcept_module'],
                    ...
                    {{-- <div class="col-md-4">
                        <div class="form-group mt10">
                            ...
                            {!! Form::select('movimiento', [], $concepto_edit['moduleConcept_movement'], [
                    ...
                    <div class="col-md-6" id="claveProdServ">
                        <div class="form-group mt10">
                            ...
                            {!! Form::text('prodServ', $concepto_edit['moduleConcept_prodServ'], [
                                'class' => 'form-control',
                                'id' => 'prodServ',
                                'autocomplete' => 'on',
                            ]) !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group mt10">
                            ...
                            {!! Form::select('status', ['Alta' => 'Alta', 'Baja' => 'Baja'], $concepto_edit['moduleConcept_status'], [
                    ...
                    <div class="col-md-12 mt50 display-flex text-center">
                        ...
                        {!! Form::submit('Guardar Concepto', ['class' => 'btn btn-warning enviar']) !!}
