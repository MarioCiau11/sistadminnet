        ...
        <div class="contentpanel">
            <div class="row row-stat">
                <div class="contenedor-formulario">
                    {!! Form::open(['route' => 'configuracion.monedas.store', 'id' => 'basicForm']) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group mt10">
                            ...
                            {!! Form::text('keyMoneda', null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group mt10">
                            ...
                            {!! Form::text('nameMoneda', null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group mt10">
                            ...
                            {!! Form::select('nameclaveSAT', $create_money_array, null, [
                    ...
                    <div class="col-md-12">
                        <div class="form-group mt10">
                            ...
                            {!! Form::number('nameTipoCambio', null, ['class' => 'form-control', 'min' => '1', 'max' => '999']) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mt10">
                            ...
                            {!! Form::textarea('nameDescripcion', null, ['class' => 'form-control', 'rows' => 4]) !!}
