        ...
        <div class="contentpanel">
            <div class="row row-stat">
                <div class="contenedor-formulario">
                    {!! Form::open(['route' => 'configuracion.roles.store', 'id' => 'basicForm']) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group mt10">
                            ...
                            {!! Form::labelNOValidacion('selectPermisos', 'Seleccionar todos los permisos', '') !!}
                        </div>
                    </div>
                                        ...
                                        <div class="tab-pane {{ $loop->first ? 'active' : '' }}"
                                            ...
                                            <div class="checkbox-container">
                                                @foreach ($categoriasPermisos[$categoria] as $permisosPorCategoria)
                                                    <div class="checkbox">
                                                        {!! Form::checkbox('permisos[]', $permisosPorCategoria['id'], [], ['class' => 'setCheckBox']) !!}
                    ...
                    <div class="col-md-12 mt20 display-center">
                        {!! Form::submit('Crear Rol', ['class' => 'btn btn-success enviar']) !!}
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
