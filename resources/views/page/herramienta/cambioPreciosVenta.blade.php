                ...
                <div class="media display-space-between">
                    <div>
                        ...
                        <div class="media-body">
                            ...
                            <h4>Cambio de Precios de Venta</h4>
                        </div>
                    ...
                    <div class="col-md-12 cabecera-informacion">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="form-group">
                                {!! Form::labelValidacion('listCompras', 'Lista de Precios', 'negrita') !!}
                                {!! Form::select(
                                    'listaProveedor',
                                    ['articles_listPrice1' => 'Precio 1', 'articles_listPrice2' => 'Precio 2', 'articles_listPrice3' => 'Precio 3', 'articles_listPrice4' => 'Precio 4', 'articles_listPrice5' => 'Precio 5' ],
                                    [],
                ...
                <div class="row" id="form-articulos-serie">
                    ...
                    <div class="col-md-12">
                        <select name="bases" id="bases" class="form-control input-sm">
                            ...
                            <option value="Precio Actual" selected>Precio Actual</option>
                        </select>
                    </div>
...
<script src="{{ asset('js/HERRAMIENTA/cambioPreciosVenta.js') }}"></script>
