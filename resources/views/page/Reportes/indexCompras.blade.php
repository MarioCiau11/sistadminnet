                        ...
                        <div class="activity-list">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12 text-center">
                                    <h4 class="report-title">Reportes de Compras</h4>
                                </div>
                                <div class="col-md-6">
                                    @can('Compras por producto y Proveedor')
                                        <div class="panel panel-default report-panel">
                                            <div class="panel-body">
                                                ...
                                                <span class="report-name">
                                                    <a class="report-link" data-recent-id="compras-articulo-provedor"
                                                        href="{{ route('vista.reportes.compras-articulo-provedor') }}">Reporte por
                                                        Proveedor</a>
                                                </span>
                                                <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                    data-placement="top" title="Marcar como favorito"
                                                    data-report-id="compras-articulo-provedor"
                                                    data-report-name="Reporte por Proveedor" data-report-identifier="report-1"
                                                    data-report-category="Compras"><i class="fa-regular fa-star"></i></button>
                                            </div>
                                        </div>
                                    @endcan
                                    @can('Compras Acumuladas por Artículo y Proveedor')
                                        <div class="panel panel-default report-panel">
                                            <div class="panel-body">
                                                <div class="pageicon pull-left ">
                                                    <i class="fa-solid fa-file-lines"></i>
                                                ...
                                                <span class="report-name"><a class="report-link"
                                                        data-recent-id="acumulado-por-articulo-proveedor"
                                                        href="{{ route('vista.reportes.acumulado-por-articulo-proveedor') }}">Reporte
                                                        Acumulado por Artículo/Proveedor</a></span>
                                                <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                    data-placement="top" title="Marcar como favorito"
                                                    data-report-id="acumulado-por-articulo-proveedor"
                                                    data-report-name="Reporte Acumulado por Artículo/Proveedor"
                                                    data-report-identifier="report-2"
                                                    data-report-category="Compras"><i class="far fa-star"></i></button>
                                ...
                                <div class="col-md-6">
                                    @can('Compras con Series')
                                        <div class="panel panel-default report-panel">
                                            <div class="panel-body">
                                                <div class="pageicon pull-left ">
                                                    <i class="fa-solid fa-file-lines"></i>
                                                </div>
                                                <span class="report-name"><a class="report-link" data-recent-id="compras-con-series"
                                                        href="{{ route('vista.reportes.compras-con-series') }}">Reporte Compras con
                                                        Serie</a></span>
                                                <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                    data-placement="top" title="Marcar como favorito"
                                                    data-report-id="compras-con-series" data-report-name="Reporte Compras con Serie"
                                                    data-report-identifier="report-3"
                                                data-report-category="Compras"><i class="fa-regular fa-star"></i></button>
                                            </div>
                                        </div>
                                    @endcan
