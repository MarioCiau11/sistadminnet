                        ...
                        <div class="activity-list">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12 text-center">
                                    <h4 class="report-title">Reportes Gerenciales</h4>
                                </div>
                                <div class="col-md-6">
                                    @can('Utilidad Ventas vs Gastos')
                                        <div class="panel panel-default report-panel">
                                            <div class="panel-body">
                                                ...
                                                <span class="report-name"><a class="report-link"
                                                        data-recent-id="utilidad-ventas-vs-gastos"
                                                        href="{{ route('vista.reportes.utilidad-ventas-vs-gastos') }}">Utilidad Ventas vs Gastos</a></span>
                                                <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                    data-placement="top" title="Marcar como favorito"
                                                    data-report-id="utilidad-ventas-vs-gastos"
                                                    data-report-name="Utilidad Ventas vs Gastos"
                                                    data-report-identifier="report-21"
                                                data-report-category="Gerenciales"><i class="far fa-star"></i></button>
                                            </div>
                                        </div>
                                    @endcan
                                </div>
