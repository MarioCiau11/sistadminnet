                        ...
                        <div class="activity-list">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12 text-center">
                                    <h4 class="report-title">Reportes de Inventarios</h4>
                                </div>
                            <div class="col-md-6">
                                @can('Inventarios - Tipo Desglosado')
                                    <div class="panel panel-default report-panel">
                                        <div class="panel-body">
                                            ...
                                            <span class="report-name"><a class="report-link"
                                                    data-recent-id="inventario-desglosado"
                                                    href="{{ route('vista.reportes.inventario.desglosado') }}">Inventarios - Tipo Desglosado</a></span>
                                            <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                data-placement="top" title="Marcar como favorito"
                                                data-report-id="inventario.desglosado"
                                                data-report-name="Inventarios - Tipo Desglosado"
                                                data-report-identifier="report-11"
                                            data-report-category="Inventarios"><i class="far fa-star"></i></button>
                                        </div>
                                    </div>
                                @endcan
                                @can('Costo Inventario al Día')
                                        <div class="panel panel-default report-panel">
                                            <div class="panel-body">
                                                <div class="pageicon pull-left ">
                                                    <i class="fa-solid fa-file-lines"></i>
                                                ...
                                                <span class="report-name"><a class="report-link"
                                                        data-recent-id="inventario.costo-dia"
                                                        href="{{ route('vista.reportes.inventario.costo-dia') }}">Costo del Inventario al día</a></span>
                                                <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                    data-placement="top" title="Marcar como favorito"
                                                    data-report-id="inventario.costo-dia"
                                                    data-report-name="Costo del Inventario al día"
                                                    data-report-identifier="report-13"
                                                    data-report-category="Inventarios"><i class="far fa-star"></i></button>
                                            </div>
                                        </div>
                                @endcan
                            ...
                            <div class="col-md-6">
                                @can('Inventarios - Tipo Concentrado')
                                    <div class="panel panel-default report-panel">
                                        <div class="panel-body">
                                            <div class="pageicon pull-left ">
                                                <i class="fa-solid fa-file-lines"></i>
                                            ...
                                            <span class="report-name"><a class="report-link"
                                                    data-recent-id="inventario.concentrado"
                                                    href="{{ route('vista.reportes.inventario.concentrado') }}">Inventarios - Tipo Concentrado</a></span>
                                            <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                data-placement="top" title="Marcar como favorito"
                                                data-report-id="inventario.concentrado"
                                                data-report-name="Inventarios - Tipo Concentrado"
                                                data-report-identifier="report-12"
                                                data-report-category="Inventarios"><i class="far fa-star"></i></button>
                                        </div>
                                    </div>
                                @endcan
