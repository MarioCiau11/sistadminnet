    ...
    <div class="mainpanel">
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                {!! Form::open(['route' => 'reportes.cxp.antiguedad-saldos.filtro', 'method' => 'POST', 'id' => 'formValidate']) !!}

                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('nameProveedorUno', 'Del Proveedor', ['class' => 'negrita']) !!}
                        {!! Form::select(
                            'nameProveedorUno', $proveedor,  session()->has('nameProveedorUno') ? session()->get('nameProveedorUno') : null,
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            'nameProveedorDos', $proveedor,  session()->has('nameProveedorDos') ? session()->get('nameProveedorDos') : null,
                            ['class' => 'widthAll select-movement select-search-hided'],
                        ) !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('nameProveedor', 'Buscar Proveedor', ['class' => 'negrita']) !!}
                        {!! Form::text('nameProveedor', session()->has('nameProveedor') ? session()->get('nameProveedor') : null, [
                            'class' => 'form-control',
                        ]) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <a href="{{ route('vista.reportes.cxp-antiguedad-saldos') }}" class="btn btn-default">Restablecer</a>
                            ...
                            <ul role="menu" id="shCol" class="dropdown-menu dropdown-menu-sm pull-right">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        ...
                                        {!! Form::label('checkSucursal', 'FechaVen', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                            ...
                            <tbody>
                                ...
                                @if (session()->has('reportes_filtro_array'))
                                    @foreach (session('reportes_filtro_array') as $cxp)
                                        @include('include.reportes.reporteCXPAntiguedadSaldos')
                                    @endforeach
                                @else
