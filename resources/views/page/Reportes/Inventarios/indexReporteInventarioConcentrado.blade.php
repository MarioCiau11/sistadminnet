    ...
    <div class="mainpanel">
                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Reporte de Inventarios - Tipo Concentrado</li>
                        </ul>
                        <h4>Reporte de Inventarios - Tipo Concentrado</h4>
                    </div>
                </div>
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                {!! Form::open(['route' => 'reportes.inventario.concentrado.filtro', 'method' => 'POST', 'id' => 'formValidate']) !!}

                <div class="col-md-2">
                    <div class="form-group">
                        {!! Form::label('nameDelArticulo', 'Del Artículo', ['class' => 'negrita']) !!}
                        {!! Form::select(
                            'nameDelArticulo', $articulos,  session()->has('nameDelArticulo') ? session()->get('nameDelArticulo') : null,
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            'nameAlArticulo', $articulos,  session()->has('nameAlArticulo') ? session()->get('nameAlArticulo') : null,
                            ['class' => 'widthAll select-movement select-search-hided'],
                        ) !!}
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            'nameGrupo',$grupos,
                            session()->has('nameGrupo') ? session()->get('nameGrupo') : null,
                            ['id' => 'select-search-hided', 'class' => 'widthAll select-status select-search-hide'],
                ...
                <div class="col-md-6">
                    <a href="{{ route('vista.reportes.inventario.concentrado') }}" class="btn btn-default">Restablecer</a>
                            ...
                            <ul role="menu" id="shCol" class="dropdown-menu dropdown-menu-sm pull-right">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        ...
                                        {!! Form::label('checkConcepto', 'Categoría', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Sucursal', '3', true, ['id' => 'checkSucursal']) !!}
                                        {!! Form::label('checkSucursal', 'Grupo', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Fecha', '4', true, ['id' => 'checkFecha']) !!}
                                        {!! Form::label('checkFecha', 'Familia', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Almacen', '5', true, ['id' => 'checkAlmacen']) !!}
                            ...
                            <tbody>
                                ...
                                @if (session()->has('reportes_filtro_array'))
                                    @foreach (session('reportes_filtro_array') as $inv)
                                        @include('include.reportes.reporteInventariosConcentrado')
                                    @endforeach
                                @else
