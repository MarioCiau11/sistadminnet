    ...
    <div class="mainpanel">
                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Reporte de Inventarios - Tipo Desglosado</li>
                        </ul>
                        <h4>Reporte de Inventarios - Tipo Desglosado</h4>
                    </div>
                </div>
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                {!! Form::open(['route' => 'reportes.inventario.desglosado.filtro', 'method' => 'POST', 'id' => 'formValidate']) !!}
                ...
                <div class="col-md-1">
                    <div class="form-group">
                        {!! Form::label('nameSerie', 'Serie', ['class' => 'negrita']) !!}
                        {!! Form::select(
                            'nameSerie',
                            [
                                'Si' => 'Si',
                            ...
                            session()->has('nameSerie') ? session()->get('nameSerie') : 'No',
                            ['id' => 'select-search-hided', 'class' => 'widthAll select-status select-search-hide'],
                        ) !!}
                    </div>
                </div>
                <div class="col-md-1">
                    <div class="form-group">
                        {!! Form::label('nameExistencia', 'Existencia', ['class' => 'negrita']) !!}
                        {!! Form::select(
                            'nameExistencia',
                            [
                                'Si' => 'Si',
                            ...
                            session()->has('nameExistencia') ? session()->get('nameExistencia') : null,
                            ['id' => 'select-search-hided', 'class' => 'widthAll select-status select-search-hide'],
                        ) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <a href="{{ route('vista.reportes.inventario.desglosado') }}" class="btn btn-default">Restablecer</a>
                            ...
                            <ul role="menu" id="shCol" class="dropdown-menu dropdown-menu-sm pull-right">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        ...
                                        {!! Form::label('checkProveedor', 'Producto', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        ...
                                        {!! Form::label('checkSucursal', 'Categoría', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Almacen2', '6', true, ['id' => 'checkAlmacen2']) !!}
                                        {!! Form::label('checkAlmacen2', 'Almacén', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <tbody>
                                ...
                                @if (session()->has('reportes_filtro_array'))
                                    @foreach (session('reportes_filtro_array') as $inv)
                                        @include('include.reportes.reporteInventariosDesglosado')
                                    @endforeach
                                @else
