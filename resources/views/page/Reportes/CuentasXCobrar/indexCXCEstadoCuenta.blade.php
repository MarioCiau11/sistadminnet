    ...
    <div class="mainpanel">
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                {!! Form::open(['route' => 'reportes.cxc.estado-cuenta.filtro', 'method' => 'POST', 'id' => 'formValidate']) !!}
                ...
                <div class="col-md-6">
                    <a href="{{ route('vista.reportes.cxc-estado-cuenta') }}" class="btn btn-default">Restablecer</a>
                    ...
                    <div class="btn-columns">
                        <div class="btn-group">
                            ...
                            <ul role="menu" id="shCol" class="dropdown-menu dropdown-menu-sm pull-right">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Movimiento2', '1', true, ['id' => 'checkMovimiento2']) !!}
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        ...
                                        {!! Form::label('checkFecha', 'Fecha de expedición', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                            ...
                            <tbody>
                                ...
                                @if (session()->has('reportes_filtro_array'))
                                    @foreach (session('reportes_filtro_array') as $cxc)
                                        @include('include.reportes.reporteCXCEstadoCuenta')
                                    @endforeach
                                @else
