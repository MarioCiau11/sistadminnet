                        ...
                        <div class="activity-list">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12 text-center">
                                    <h4 class="report-title">Reportes de Cuentas por Pagar</h4>
                                </div>
                                    <div class="col-md-6">
                                        @can('Antigüedad de Saldos CxP')
                                            <div class="panel panel-default report-panel">
                                                <div class="panel-body">
                                                    ...
                                                    <span class="report-name"><a class="report-link"
                                                            data-recent-id="cxp-antiguedad-saldos"
                                                            href="{{ route('vista.reportes.cxp-antiguedad-saldos') }}">Antiguedad de Saldos CxP</a></span>
                                                    <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                        data-placement="top" title="Marcar como favorito"
                                                        data-report-id="cxp-antiguedad-saldos"
                                                        data-report-name="Antiguedad de Saldos CxP"
                                                        data-report-identifier="report-16"
                                                        data-report-category="CxP"><i class="far fa-star"></i></button>
                                                </div>
                                            </div>
                                        @endcan
                                    </div>
                                    <div class="col-md-6">
                                        @can('Estado de cuenta CxP')
                                            <div class="panel panel-default report-panel">
                                                <div class="panel-body">
                                                    <div class="pageicon pull-left ">
                                                        <i class="fa-solid fa-file-lines"></i>
                                                    ...
                                                    <span class="report-name"><a class="report-link"
                                                            data-recent-id="cxp-estado-cuenta"
                                                            href="{{ route('vista.reportes.cxp-estado-cuenta') }}">Estado de Cuenta CxP</a></span>
                                                    <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                        data-placement="top" title="Marcar como favorito"
                                                        data-report-id="cxp-estado-cuenta"
                                                        data-report-name="Estado de Cuenta CxP"
                                                        data-report-identifier="report-17"
                                                        data-report-category="CxP"><i class="far fa-star"></i></button>
                                                </div>
                                            </div>
                                        @endcan
