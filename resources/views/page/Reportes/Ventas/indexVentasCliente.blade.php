    ...
    <div class="mainpanel">
                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Ventas por Artículo y Cliente</li>
                        </ul>
                        <h4>Ventas por Artículo y Cliente</h4>
                    </div>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                {!! Form::open([
                    'route' => 'reportes.ventas.cliente.filtro',
                    'method' => 'POST',
                    'id' => 'formValidate',
                ]) !!}
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ route('vista.reportes.ventas-cliente-articulo') }}" class="btn btn-default">Restablecer</a>
                            ...
                            <ul role="menu" id="shCol" class="dropdown-menu dropdown-menu-sm pull-right">
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        ...
                                        {!! Form::label('checkOpciones', 'Cliente', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('name', '4', true, ['id' => 'checkName']) !!}
                                        {!! Form::label('checkName', 'Artículo', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('position', '5', true, ['id' => 'checkPosition']) !!}
                                        {!! Form::label('checkPosition', 'Unidad', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('office', '6', true, ['id' => 'checkOffice']) !!}
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Concepto', '9', true, ['id' => 'checkConcepto']) !!}
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Cliente', '10', true, ['id' => 'checkCliente']) !!}
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('ClienteClave', '11', true, ['id' => 'checkClienteClave']) !!}
                            ...
                            <tbody>
                                ...
                                @if (session()->has('reportes_filtro_array'))
                                    @foreach (session('reportes_filtro_array') as $venta)
                                        @include('include.reportes.reporteVentasCliente')
                                    @endforeach
                                @else
