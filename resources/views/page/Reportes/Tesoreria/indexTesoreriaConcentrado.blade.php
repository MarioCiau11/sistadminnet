    ...
    <div class="mainpanel">
                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Auxiliares por Cuenta de Dinero Nivel - Concentrado</li>
                        </ul>
                        <h4>Auxiliares por Cuenta de Dinero Nivel - Concentrado</h4>
                    </div>
                </div>
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                {!! Form::open([
                    'route' => 'reportes.tesoreria.concentrados.filtro',
                    'method' => 'POST',
                    'id' => 'formValidate',
                ]) !!}
                ...
                <div class="col-md-6">
                    <a href="{{ route('vista.reportes.tesoreria-concentrados') }}" class="btn btn-default">Restablecer</a>
                    ...
                    <div class="btn-columns">
                        <div class="btn-group">
                            ...
                            <ul role="menu" id="shCol" class="dropdown-menu dropdown-menu-sm pull-right">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Fecha de vencimiento', '2', true, ['id' => 'checkConcepto']) !!}
                                        {!! Form::label('checkConcepto', 'Fecha de vencimiento', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                {{-- <li>
                                    <div class="ckbox ckbox-primary">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Moneda', '3', true, ['id' => 'checkFecha']) !!}
                            ...
                            <tbody>
                                ...
                                @if (session()->has('reportes_filtro_array'))
                                    @foreach (session('reportes_filtro_array') as $din)
                                        @include('include.reportes.reporteTesoreriaConcentrado')
                                    @endforeach
                                @else
