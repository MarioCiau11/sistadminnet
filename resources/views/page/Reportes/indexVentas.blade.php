                        ...
                        <div class="activity-list">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12 text-center">
                                    <h4 class="report-title">Reportes de Ventas</h4>
                                </div>
                                    <div class="col-md-6">
                                        @can('Ventas por producto y Cliente')
                                            <div class="panel panel-default report-panel">
                                                <div class="panel-body">
                                                    ...
                                                    <span class="report-name">
                                                        <a class="report-link" data-recent-id="ventas-cliente-articulo"
                                                            href="{{ route('vista.reportes.ventas-cliente-articulo') }}">Reporte
                                                            por Cliente</a>
                                                    </span>
                                                    <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                        data-placement="top" title="Marcar como favorito"
                                                        data-report-id="ventas-cliente-articulo"
                                                        data-report-name="Reporte por Cliente" data-report-identifier="report-4"
                                                        data-report-category="Ventas">
                                                        <i class="fa-regular fa-star"></i></button>
                                                </div>
                                            </div>
                                        @endcan
                                        @can('Ventas con Series')
                                            <div class="panel panel-default report-panel">
                                                <div class="panel-body">
                                                    <div class="pageicon pull-left ">
                                                        <i class="fa-solid fa-file-lines"></i>
                                                    ...
                                                    <span class="report-name"><a class="report-link"
                                                            data-recent-id="ventas-serie"
                                                            href="{{ route('vista.reportes.ventas-serie') }}">Reporte Ventas con
                                                            Serie</a></span>
                                                    <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                        data-placement="top" title="Marcar como favorito"
                                                        data-report-id="ventas-serie" data-report-name="Reporte Compras con Serie"
                                                        data-report-identifier="report-5"
                                                    data-report-category="Ventas"><i class="far fa-star"></i></button>
                                                </div>
                                            </div>
                                        @endcan
                                    </div>
                                        ...
                                        @can('Lista Precios')
                                            <div class="panel panel-default report-panel">
                                                <div class="panel-body">
                                                    ...
                                                    <span class="report-name"><a class="report-link"
                                                            data-recent-id="listaPrecios"
                                                            href="{{ route('vista.reportes.listaPrecios') }}">Lista de
                                                            Precios</a></span>
                                                    <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                        data-placement="top" title="Marcar como favorito"
                                                        data-report-id="listaPrecios" data-report-name="Lista de Precios"
                                                        data-report-identifier="report-6"
                                                    data-report-category="Ventas"><i class="far fa-star"></i></button>
                                                </div>
                                            </div>
                                        @endcan
                                        @can('Productos más Vendidos')
                                            <div class="panel panel-default report-panel">
                                                <div class="panel-body">
                                                    <div class="pageicon pull-left ">
                                                        <i class="fa-solid fa-file-lines"></i>
                                                    ...
                                                    <span class="report-name"><a class="report-link"
                                                            data-recent-id="ventas-producto-mas-vendido"
                                                            href="{{ route('vista.reportes.ventas-producto-mas-vendido') }}">Reporte
                                                            Producto Más Vendido</a></span>
                                                    <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                        data-placement="top" title="Marcar como favorito"
                                                        data-report-id="ventas-producto-mas-vendido"
                                                        data-report-name="Reporte Producto Más Vendido"
                                                        data-report-identifier="report-7"
                                                        data-report-category="Ventas"><i class="far fa-star"></i></button>
                                                </div>
                                            </div>
                                        @endcan
                                        ...
                                        @can('Ventas vs Ganancias')
                                            <div class="panel panel-default report-panel">
                                                <div class="panel-body">
                                                    ...
                                                    <span class="report-name"><a class="report-link"
                                                            data-recent-id="ventas-ganancia"
                                                            href="{{ route('vista.reportes.ventas-ganancia') }}">Reporte Ventas VS
                                                            Ganancia</a></span>
                                                    <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                        data-placement="top" title="Marcar como favorito"
                                                        data-report-id="ventas-ganancia"
                                                        data-report-name="Reporte Ventas VS Ganancia"
                                                        data-report-identifier="report-8"
                                                        data-report-category="Ventas"><i class="far fa-star"></i></button>
                                                </div>
                                            </div>
                                        @endcan
