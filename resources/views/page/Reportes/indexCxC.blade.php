                        ...
                        <div class="activity-list">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12 text-center">
                                    <h4 class="report-title">Reportes de Cuentas por Cobrar</h4>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="panel panel-default report-panel">
                                            <div class="panel-body">
                                                ...
                                                <span class="report-name"><a class="report-link"
                                                        data-recent-id="cxc-antiguedad-saldos"
                                                        href="{{ route('vista.reportes.cxc-antiguedad-saldos') }}">Antiguedad de Saldos CxC</a></span>
                                                <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                    data-placement="top" title="Marcar como favorito"
                                                    data-report-id="cxc-antiguedad-saldos"
                                                    data-report-name="Antiguedad de Saldos CxC"
                                                    data-report-identifier="report-18"
                                                    data-report-category="CxC"><i class="far fa-star"></i></button>
                                            </div>
                                        </div>
                                    @endcan
                                    @can('Cobranzas por Forma Cobro')
                                        <div class="panel panel-default report-panel">
                                            <div class="panel-body">
                                                <div class="pageicon pull-left ">
                                                    <i class="fa-solid fa-file-lines"></i>
                                                ...
                                                <span class="report-name"><a class="report-link"
                                                        data-recent-id="cxc-cobranza-forma-cobro"
                                                        href="{{ route('vista.reportes.cxc-cobranza-forma-cobro') }}">Cobranza por Forma de Cobro</a></span>
                                                <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                    data-placement="top" title="Marcar como favorito"
                                                    data-report-id="cxc-cobranza-forma-cobro"
                                                    data-report-name="Cobranza por Forma de Cobro"
                                                    data-report-identifier="report-20"
                                                    data-report-category="CxC"><i class="far fa-star"></i></button>
                                            </div>
                                        </div>
                                    @endcan
                                    ...
                                    @can('Estado de cuenta')
                                        <div class="panel panel-default report-panel">
                                            <div class="panel-body">
                                                ...
                                                <span class="report-name"><a class="report-link"
                                                        data-recent-id="cxc-estado-cuenta"
                                                        href="{{ route('vista.reportes.cxc-estado-cuenta') }}">Estado de Cuenta CxC</a></span>
                                                <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                    data-placement="top" title="Marcar como favorito"
                                                    data-report-id="cxc-estado-cuenta"
                                                    data-report-name="Estado de Cuenta CxC"
                                                    data-report-identifier="report-19"
                                                    data-report-category="CxC"><i class="far fa-star"></i></button>
                                            </div>
                                        </div>
                                    @endcan
