    ...
    <div class="mainpanel">
                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Compras por Artículo y Proveedor</li>
                        </ul>
                        <h4>Compras por Artículo y Proveedor</h4>
                    </div>
                </div>
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                {!! Form::open([
                    'route' => 'reportes.compras.articulo-proveedor.filtro',
                    'method' => 'POST',
                    'id' => 'formValidate',
                ]) !!}
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            ...
                            session()->has('nameMov') ? session()->get('nameMov') : 'Entrada por Compra',
                            ['class' => 'widthAll select-movement select-search-hided'],
                        ) !!}
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            ...
                            session()->has('status') ? session()->get('status') : 'FINALIZADO',
                            ['class' => 'widthAll select-status select-search-hide'],
                        ) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <a href="{{ route('vista.reportes.compras-articulo-provedor') }}"
                            ...
                            <tbody>
                                ...
                                @if (session()->has('reportes_filtro_array'))
                                    @foreach (session('reportes_filtro_array') as $compra)
                                        @include('include.reportes.reporteComprasArticuloProveedor')
                                    @endforeach
                                @else
