    ...
    <div class="mainpanel">
            ...
            <div class="media display-space-between">
                <div>
                    <div class="pageicon pull-left mr10">
                        <span class="fa-solid fa-comment-dollar"></span>
                    </div>
                    <div class="media-body">
                        <ul class="breadcrumb">
                            <li><a href="{{ route('dashboard.index') }}"><i class="glyphicon glyphicon-home"></i></a></li>
                            <li>Compras Acumuladas por Artículo y Proveedor</li>
                        </ul>
                        <h4>Compras Acumuladas por Artículo y Proveedor</h4>
                    </div>
                </div>
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                {!! Form::open([
                    'route' => 'reportes.compras.acumulado-articulo-proveedor.filtro',
                    'method' => 'POST',
                    'id' => 'formValidate',
                ]) !!}
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        {!! Form::label('nameProveedorUno', 'Del Proveedor', ['class' => 'negrita']) !!}
                        {!! Form::select(
                            'nameProveedorUno', $proveedores,  session()->has('nameProveedorUno') ? session()->get('nameProveedorUno') : null,
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        {!! Form::label('nameProveedorDos', 'Al Proveedor', ['class' => 'negrita']) !!}
                        {!! Form::select(
                            'nameProveedorDos', $proveedores,  session()->has('nameProveedorDos') ? session()->get('nameProveedorDos') : null,
                            ['class' => 'widthAll select-movement select-search-hided'],
                        ) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <a href="{{ route('vista.reportes.acumulado-por-articulo-proveedor') }}"
                            ...
                            <ul role="menu" id="shCol" class="dropdown-menu dropdown-menu-sm pull-right">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        ...
                                        {!! Form::label('checkMovimiento', 'Artículo', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        ...
                                        {!! Form::label('checkArticulo', 'Categoría Artículo', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Unidad', '5', true, ['id' => 'checkUnidad']) !!}
                                        {!! Form::label('checkUnidad', 'Grupo Artículo', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Fecha', '6', true, ['id' => 'checkFecha']) !!}
                                        {!! Form::label('checkFecha', 'Familia Artículo', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        ...
                                        {!! Form::label('checkMoneda1', 'Fecha', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Ejercicio', '9', true, ['id' => 'checkMoneda2']) !!}
                                        {!! Form::label('checkMoneda2', 'Ejercicio', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <tbody>
                                ...
                                @if (session()->has('reportes_filtro_array'))
                                    @foreach (session('reportes_filtro_array') as $compra)
                                        @include('include.reportes.reporteComprasAcumuladas')
                                    @endforeach
                                @else
