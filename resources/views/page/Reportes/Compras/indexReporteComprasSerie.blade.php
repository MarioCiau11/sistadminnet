    ...
    <div class="mainpanel">
                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Compras con series</li>
                        </ul>
                        <h4>Compras con series</h4>
                    </div>
                </div>
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                {!! Form::open([
                    'route' => 'reportes.compras.series.filtro',
                    'method' => 'POST',
                    'id' => 'formValidate',
                ]) !!}
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            'series',
                            $series,
                            session()->has('series') ? session()->get('series') : null,
                            ['class' => 'widthAll select-status select-search-hide'],
                        ) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <a href="{{ route('vista.reportes.compras-con-series') }}"
                            ...
                            <ul role="menu" id="shCol" class="dropdown-menu dropdown-menu-sm pull-right">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        ...
                                        {!! Form::label('checkCategoria', 'Nombre Proveedor', ['class' => 'negrita']) !!}
                                    </div>
                                </li>
                                {{-- <li>
                                    <div class="ckbox ckbox-primary">
                                ...
                                <li>
                                    <div class="ckbox ckbox-primary">
                                        {!! Form::checkbox('Sucursal', '4', false, ['id' => 'checkSucursal']) !!}
                            ...
                            <tbody>
                                ...
                                @if (session()->has('reportes_filtro_array'))
                                    @foreach (session('reportes_filtro_array') as $compra)
                                        @include('include.reportes.reporteComprasSeries')
                                    @endforeach
                                @else
