                        ...
                        <div class="activity-list">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12 text-center">
                                    <h4 class="report-title">Reportes de Gastos</h4>
                                </div>
                                    <div class="col-md-6">
                                        @can('Gastos por concepto')
                                            <div class="panel panel-default report-panel">
                                                <div class="panel-body">
                                                    ...
                                                    <span class="report-name"><a class="report-link"
                                                            data-recent-id="gastos-concepto"
                                                            href="{{ route('vista.reportes.gastos-concepto') }}">Gastos por Concepto</a></span>
                                                    <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                        data-placement="top" title="Marcar como favorito"
                                                        data-report-id="gastos-concepto"
                                                        data-report-name="Gastos por Concepto"
                                                        data-report-identifier="report-14"
                                                            data-report-category="Gastos"><i class="far fa-star"></i></button>
                                                </div>
                                            </div>
                                        @endcan
                                    </div>
                                    <div class="col-md-6">
                                        @can('Gastos por Activo Fijo')
                                            <div class="panel panel-default report-panel">
                                                <div class="panel-body">
                                                    <div class="pageicon pull-left ">
                                                        <i class="fa-solid fa-file-lines"></i>
                                                    ...
                                                    <span class="report-name"><a class="report-link"
                                                            data-recent-id="gastos-antecedente-activo-fijo"
                                                            href="{{ route('vista.reportes.gastos-antecedente-activo-fijo') }}">Gastos por Activo Fijo</a></span>
                                                    <button class="btn btn-default pull-right favorite-btn" data-toggle="tooltip"
                                                        data-placement="top" title="Marcar como favorito"
                                                        data-report-id="gastos-antecedente-activo-fijo"
                                                        data-report-name="Gastos por Activo Fijo"
                                                        data-report-category="Gastos"><i class="far fa-star"></i></button>
                                                </div>
                                            </div>
                                        @endcan
