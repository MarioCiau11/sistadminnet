    ...
    <div class="mainpanel">
                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Cuentas por Pagar / Anexos</li>
                        </ul>
                        <h4>Anexos</h4>
                    </div>

                </div>
                <h3 class="text-black text-center">{{ $movimiento->accountsPayable_movement }} :
                    <strong>#{{ $movimiento->accountsPayable_movementID }} </strong>
                </h3>
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                            ...
                            <div class="col-sm-12">
                                <div class="row media-manager">
                                    @foreach ($anexosFiles as $anexosFile)
                                        ...
                                        $FileArray = explode('/', $anexosFile['accountsPayableFiles_file']);
                                        $longitudFile = count($FileArray);
                                        $file = $FileArray[$longitudFile - 1];
                                        $quitamosDoblesDiagonales = str_replace(['//', '///', '////'], '/', 'archivo/' . $anexosFile->accountsPayableFiles_path);
                                        ?>
                                                ...
                                                <div class="btn-group fm-group" style="display: block;">
                                                    ...
                                                    <ul class="dropdown-menu fm-menu pull-right" role="menu">
                                                        ...
                                                        <li><a class="eliminar-file" style="cursor: pointer">
                                                                {!! Form::open([
                                                                    'route' => ['modulo.cuentasPagar.anexos.delete', 'id' => $anexosFile->accountsPayableFiles_id],
                                                                    'method' => 'DELETE',
                                                                ]) !!}
                ...
                {!! Form::open([
                    'route' => ['modulo.cuentasPagar.anexos.store', 'id' => $id],
                    'method' => 'POST',
                    'class' => 'dropzone',
                    'id' => 'myDropzone',
