    ...
    <div class="mainpanel">
                ...
                <div>
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Cuentas por Cobrar / Anexos</li>
                        </ul>
                        <h4>Anexos</h4>
                    </div>

                </div>
                <h3 class="text-black text-center">{{ $movimiento->accountsReceivable_movement }} :
                    <strong>#{{ $movimiento->accountsReceivable_movementID }} </strong>
                </h3>
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                            ...
                            <div class="col-sm-12">
                                <div class="row media-manager">
                                    @foreach ($anexosFiles as $anexosFile)
                                        ...
                                        $FileArray = explode('/', $anexosFile['accountsReceivableFiles_file']);
                                        $longitudFile = count($FileArray);
                                        $file = $FileArray[$longitudFile - 1];
                                        $quitamosDoblesDiagonales = str_replace(['//', '///', '////'], '/', '/archivo/' . $anexosFile->accountsReceivableFiles_path);
                                        ?>
                                                ...
                                                <div class="btn-group fm-group" style="display: block;">
                                                    ...
                                                    <ul class="dropdown-menu fm-menu pull-right" role="menu">
                                                        ...
                                                        <li><a class="eliminar-file" style="cursor: pointer">
                                                                {!! Form::open([
                                                                    'route' => ['modulo.cxc.anexos.delete', 'id' => $anexosFile->accountsReceivableFiles_id],
                                                                    'method' => 'DELETE',
                                                                ]) !!}
                ...
                {!! Form::open([
                    'route' => ['modulo.cxc.anexos.store', 'id' => $id],
                    'method' => 'POST',
                    'class' => 'dropzone',
                    'id' => 'myDropzone',
