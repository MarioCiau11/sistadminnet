    ...
    <div class="mainpanel">
        <div class="pageheader">
            <div class="media display-space-between">
                ...
                <h3 class="text-black text-center">{{ $movimiento->purchase_movement }} :
                    <strong>#{{ $movimiento->purchase_movementID }} </strong>
                </h3>
            </div><!-- media -->
        </div><!-- pageheader -->
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                            ...
                            <div class="col-sm-12">
                                <div class="row media-manager">
                                    @foreach ($anexosFiles as $anexosFile)
                                        ...
                                        $FileArray = explode('/', $anexosFile['purchaseFiles_file']);
                                        $longitudFile = count($FileArray);
                                        $file = $FileArray[$longitudFile - 1];
                                        $quitamosDoblesDiagonales = str_replace(['//', '///', '////'], '/', 'archivo/' . $anexosFile->purchaseFiles_path);
                                        ?>
                                                ...
                                                <div class="btn-group fm-group" style="display: block;">
                                                    ...
                                                    <ul class="dropdown-menu fm-menu pull-right" role="menu">
                                                        ...
                                                        <li><a class="eliminar-file" style="cursor: pointer">
                                                                {!! Form::open([
                                                                    'route' => ['modulo.compras.anexos.delete', 'id' => $anexosFile->purchaseFiles_id],
                                                                    'method' => 'DELETE',
                                                                ]) !!}
                ...
                {!! Form::open([
                    'route' => ['modulo.compras.anexos.store', 'id' => $id],
                    'method' => 'POST',
                    'class' => 'dropzone',
                    'id' => 'myDropzone',
