    ...
    <div class="mainpanel">
        <div class="pageheader">
            <div class="media display-space-between">
                ...
                <h3 class="text-black text-center">{{ $movimiento->sales_movement }} :
                    <strong>#{{ $movimiento->sales_movementID }} </strong>
                </h3>
        ...
        <div class="contentpanel">
            <div class="row row-stat">
                            ...
                            <div class="col-sm-12">
                                <div class="row media-manager">
                                    @foreach ($anexosFiles as $anexosFile)
                                        ...
                                        $FileArray = explode('/', $anexosFile['salesFiles_file']);
                                        $longitudFile = count($FileArray);
                                        $file = $FileArray[$longitudFile - 1];
                                        $quitamosDoblesDiagonales = str_replace(['//', '///', '////'], '/', 'archivo/' . $anexosFile->salesFiles_path);
                                        ?>
                                                ...
                                                <div class="btn-group fm-group" style="display: block;">
                                                    ...
                                                    <ul class="dropdown-menu fm-menu pull-right" role="menu">
                                                        ...
                                                        <li><a class="eliminar-file" style="cursor: pointer">
                                                                {!! Form::open([
                                                                    'route' => ['modulo.ventas.anexos.delete', 'id' => $anexosFile->salesFiles_id],
                                                                    'method' => 'DELETE',
                                                                ]) !!}
                ...
                {!! Form::open([
                    'route' => ['modulo.ventas.anexos.store', 'id' => $id],
                    'method' => 'POST',
                    'class' => 'dropzone',
                    'id' => 'myDropzone',
