    ...
    <table class="cabecera ancho">
        ...
        <tr>
            ...
            <td class="info-compra">
                <h1 style="color: #0171c0">COTIZACIÓN</h1>
                ...
                <p style="border: 1px solid black; padding: 5px;"><strong>Agente: </strong> {{ $venta->sales_seller }}</p>
...
<body>
        ...
        @foreach ($articulos_venta as $key => $articulo)
            <tr>
                ...
                <td style="text-align: right; border: 1px solid black; padding: 3px;">
                    ${{ number_format($articulo->salesDetails_unitCost, 2) }}</td>
    ...
    <table class="costos-desglosados">
        ...
        <tr>
            ...
            <td>
                <p class="numeros-reportes" style="text-align: right; border: 1px dotted black; padding: 3px;">16%</p>
            </td>
        </tr>
        <?php
        
        $importe_iva = ($totales - $descuento) * 0.16;
        ...
        <tr>
            ...
            <td style="border-top: 1px solid black">
                <p class="numeros-reportes" style="text-align: right">$
                    {{ number_format(($totales - $descuento) * 1.16, 2) }}</p>
            </td>
        </tr>
